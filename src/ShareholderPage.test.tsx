...
describe("ShareholderPage", () => {
  ...
  it("should allow adding new grants", async () => {
    ...
    const grantTypeSelect = screen.getByTestId("grant-type");
    ...
    await waitFor(() => {
      ...
      await waitFor(() => {
        // Clicking Save in this repo seems to be flaky, as if its getting
        // called before the values are updated. This addresses that, but
        // i'm not sure it really does anything or I just got lucky...
